%% Room environment for single LED
...
% Position of LED [m] (z=0 is the floor, z=lz is the roof, x=-lx/2 is the
% left wall). Accepts multiple sources
r_s = [0,  0,  2.5];

% Orientation of the source (z=1 is looking up, z=-1 is looking down).
% Accepts multiple sources.
n_s = [ 0,  0,  -1];

z_rx = 2.2;          % [m] Position of the receiver in the "Z" axis.
n_r = [0, 0, 1];       % Orientation of the receiver (z=1 is looking up, z=-1 is looking down).
