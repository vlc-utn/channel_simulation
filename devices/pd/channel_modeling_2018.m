%% PD proposed from "Optical wireless communications: system and channel modelling with MATLAB", page 92, program 3:3
...
responsivity = 1;   % [A/W] Responsivity of the photodiode.
