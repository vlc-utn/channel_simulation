% TODO graphs don't match exactly. There must be an error in the code

%% RMS Spread
% Simulate RMS spread of the optical channel.
% The results are comparable with the graphs on:
